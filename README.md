...
> *"Trabajo con lo que tengo y confío en que con esfuerzo y fe llegaré lejos."*
...
La estética que lo define se llama **Digital Cosmos** — oscura, profunda, con destellos de índigo eléctrico y ámbar dorado.

---

## 🎨 Paleta Digital Cosmos
...
| `--primary` | `#6C63FF` 💜 | Color primario / índigo eléctrico |
| `--accent` | `#F5A623` 🟡 | Acento / ámbar dorado |
...
```bash
git clone https://github.com/Manu270422/elmundodemanu.git
cd elmundodemanu
```
...
¡Las contribuciones son bienvenidas! Si quieres apoyar este proyecto:
...
```
MIT License © 2026 Carlos Manuel Turizo Hernández
```
